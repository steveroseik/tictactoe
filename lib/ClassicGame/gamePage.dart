...
class GamePage extends StatefulWidget {
  ...
  final Function(Map<String, dynamic>) setMove;
  final Function(Map<String, dynamic>) confirmMove;
  final Socket socket;
  const GamePage({super.key,
    required this.controller,
    required this.socket,
    required this.setMove, required this.confirmMove});
...
class _GamePageState extends State<GamePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MainController>(
      builder: (BuildContext context, MainController dataEngine, Widget? child) {
